...
<div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow-md border border-gray-200">
    <h2 class="text-xl font-semibold text-gray-800 mb-4">Form Tambah Transaksi</h2>

    <form action="{{ route('transaksi-arisan.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="number" name="total_setoran" id="total_setoran" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
        </div>
        ...
        <div class="mb-4">
            <label class="inline-flex items-center">
                <input type="checkbox" name="status_menang_arisan" value="1" class="form-checkbox text-blue-600">
                <span class="ml-2 text-sm text-gray-700">Menang</span>
                <input type="checkbox" name="status_menang_arisan" value="0" class="form-checkbox text-blue-600">
